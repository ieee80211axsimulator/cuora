...
enum WifiMacType
{
  ...
  WIFI_MAC_MGT_BEACON,
  WIFI_MAC_MGT_TF_BEACON, //infocom: Define TF_Beacon MAC Type, part of MGT, but implementing separately
...
public:
  ...
  void SetTriggerFrameBeacon (void); //infocom: TF definitions
  ...
  bool IsTFBeacon (void) const; // infocom: Trigger Frame definitions
