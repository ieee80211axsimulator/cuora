...
public:
  ...
  Time CalculateTfDuration (void);
  void TriggerFrameBeaconExpire ();
...
private:
  ...
  void Shim (Ptr<const Packet> packet, Mac48Address from, Mac48Address to, uint8_t tid);
  /**
   ...
   */
  void SendTriggerFrameBeacon (void);
  ...
  RUAllocations m_tfBeaconAlloc;                   //!< infocom: Allocations sent in the TF Beacon 
