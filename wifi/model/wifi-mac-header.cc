...
WifiMacHeader::SetType (WifiMacType type)
{
  switch (type)
    ...
    case WIFI_MAC_MGT_MULTIHOP_ACTION:
      ...
      m_ctrlSubtype = 16;
      break;
    case WIFI_MAC_MGT_TF_BEACON: //infocom: Type and subtype for TF beacon, TF response, TF 
      m_ctrlType = TYPE_MGT;
      m_ctrlSubtype = 10;
      break;
  ...
  switch (m_ctrlType)
    ...
    case TYPE_MGT:
      switch (m_ctrlSubtype)
        ...
        case 10:
          return WIFI_MAC_MGT_TF_BEACON; //GetType for TF
        case 11:
          return WIFI_MAC_MGT_TF_RESP;
        case 12:
          return WIFI_MAC_MGT_TF;
        case 13:
          return WIFI_MAC_MGT_BSR_ACK;
        case 14:
...
void
WifiMacHeader::SetTriggerFrameBeacon (void) //infocom: set TF beacon, response and TF
{
  m_ctrlType = TYPE_MGT;
  m_ctrlSubtype = 10;
}
...
bool
WifiMacHeader::IsTFBeacon (void) const //infocom: TF
{
  return (GetType () == WIFI_MAC_MGT_TF_BEACON);
}
...
WifiMacHeader::Print (std::ostream &os) const
{
  ...
  switch (GetType ())
    ...
    case WIFI_MAC_MGT_AUTHENTICATION:
    case WIFI_MAC_MGT_DEAUTHENTICATION:
    case WIFI_MAC_MGT_TF_BEACON: //infocom: TF
